...
public class PermissionTypeController {
    ...
    public Result updateResource(@RequestBody Resource resource){
        return permissionTypeService.updateResource(resource);
    }

    @PostMapping("/update/uri")
    public Result updateUri(@RequestBody PermissionTypeUri permissionTypeUri){
        return permissionTypeService.updateUri(permissionTypeUri);
    }

    @PostMapping("/update/type")
    public Result updateType(@RequestBody PermissionType permissionType){
        return permissionTypeService.updateType(permissionType);
    }
}
